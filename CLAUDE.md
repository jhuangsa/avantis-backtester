...
Hypothesis: a named side, its entries, a take profit, a stop loss, and any rule exit or time exit. Or long, short, or flat, named from bars that have already closed, with no target and no stop.
